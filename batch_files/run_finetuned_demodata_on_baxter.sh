...
#SBATCH --output=batch_files/finetuned_demodata_on_baxter_output_%j.log      # Standard output log
...
python -u scripts/get_trajectory_mse.py -em new_embodiment --data_config baxter_arms -d novideo_data -ckpt models/finetuned-demodata-model -p Finetuned-Policy-DemoData-On-Baxter
conda deactivate
