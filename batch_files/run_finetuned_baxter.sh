...
#SBATCH --job-name=Baxter_Fine_Tune  # Job name
...
#SBATCH --output=batch_files/finetuned_baxter_output_%j.log      # Standard output log
...
python -u scripts/get_trajectory_mse.py -em new_embodiment -dc baxter_arms -d novideo_data -ckpt models/finetuned-baxter-model -p Finetuned-Policy-Baxter
conda deactivate
