...
python -u scripts/get_trajectory_mse.py -em new_embodiment -dc baxter_arms -d demo_data/robot_sim.PickNPlace -ckpt models/finetuned-baxter-model -p Finetuned-Policy-Baxter-On-Demodata
conda deactivate
